...
contract second {
    ...
    function addProduct(uint32 _ownerId, 
        ...
        if(keccak256(abi.encodePacked(participants[_ownerId].participantType)) == keccak256("seller")) {
    ...
    function newOwner(uint32 _user1Id, uint32 _user2Id, uint32 _prodId) onlyOwner(_prodId) public returns (bool) {
        ...
        if(keccak256(abi.encodePacked(p1.participantType)) == keccak256("seller")
           && keccak256(abi.encodePacked(p2.participantType)) == keccak256("server")){
         ...
         else if(keccak256(abi.encodePacked(p1.participantType)) == keccak256("server")
           && keccak256(abi.encodePacked(p2.participantType)) == keccak256("testing")) {
           ownerships[ownership_id].productId = _prodId;
           ownerships[ownership_id].productOwner = p2.participantAdderss;
           ownerships[ownership_id].ownerId = _user2Id;
           ownerships[ownership_id].trxTimeStamp = uint32(block.timestamp);
         ...
         else if(keccak256(abi.encodePacked(p1.participantType)) == keccak256("testing")
           && keccak256(abi.encodePacked(p2.participantType)) == keccak256("sender")) {
           ownerships[ownership_id].productId = _prodId;
           ownerships[ownership_id].productOwner = p2.participantAdderss;
           ownerships[ownership_id].ownerId = _user2Id;
           ownerships[ownership_id].trxTimeStamp = uint32(block.timestamp);
         ...
         else if(keccak256(abi.encodePacked(p1.participantType)) == keccak256("sender")
           && keccak256(abi.encodePacked(p2.participantType)) == keccak256("buyer")) {
           ownerships[ownership_id].productId = _prodId;
           ownerships[ownership_id].productOwner = p2.participantAdderss;
           ownerships[ownership_id].ownerId = _user2Id;
           ownerships[ownership_id].trxTimeStamp = uint32(block.timestamp);
